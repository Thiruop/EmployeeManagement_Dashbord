...
const EmployeeList = () => {
  ...
  <div className="overflow-x-auto">
    <table className="w-full">
      <thead>
        <tr className="grid grid-cols-8 gap-4 border-b text-left text-sm font-medium text-gray-500 tracking-wider">
        ...
        {filteredEmployees.length > 0 ? (
          filteredEmployees.map((employee) => (
            <tr
              ...
              className="grid grid-cols-8 gap-4 items-center py-3 hover:bg-gray-50"
            >
